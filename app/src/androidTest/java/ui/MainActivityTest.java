...
//
//        ViewInteraction appCompatEditText = onView(withId(R.id.loginText));
//        appCompatEditText.perform(replaceText("1huhu*&^2345"), closeSoftKeyboard());
//
//        ViewInteraction materialButton = onView(withId(R.id.loginButton));
//        materialButton.perform(click());
//
...
//
//        ViewInteraction appCompatEditText = onView(withId(R.id.loginText));
//        appCompatEditText.perform(replaceText("123gyugyJHHI45"), closeSoftKeyboard());
//
//        ViewInteraction materialButton = onView(withId(R.id.loginButton));
//        materialButton.perform(click());
//
...
//
//        ViewInteraction appCompatEditText = onView(withId(R.id.loginText));
//        appCompatEditText.perform(replaceText("12cgdgdDGEGEG$%345"), closeSoftKeyboard());
//
//        ViewInteraction materialButton = onView(withId(R.id.loginButton));
//        materialButton.perform(click());
//
